...
<body>
    <div id="app">
            ...
            {{-- <div class="container"> --}}
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav">
                        @yield('active')
                        {{-- <li class="nav-item">
                            <a class="nav-link active navigation" aria-current="page" href="{{route('home')}}">Accueil</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link active navigation" aria-current="page" href="{{url('/produit')}}">Produits</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link active navigation" aria-current="page" href="{{url('/services')}}">Services</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link active navigation" aria-current="page" href="{{url('/contact')}}">Contact</a>
                        </li> --}}
        ...
        <div class="footer">
            <p class="text-center mb-5" style="font-size: 20px">Sté Ben-Bazid</p>
            ...
            <div class="container d-flex">
                ...
                <div class="col-md-3 col-sm-12" >
                    ...
                    <div class="m-auto text-center">
                        <h1><i class="fas fa-globe mr-2"></i> Site</h1>
                    </div>
                ...
                <div class="col-md-3 col-sm-12" >
                    ...
                    <div class="m-auto text-center">
                        <h2> <i class="fas fa-headset mr-2"></i> Contact</h2>
                    </div>

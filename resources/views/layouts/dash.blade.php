...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('style/backend/style.css') }}" />
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown" >
                            <a class="nav-link dropdown-toggle d-flex second-text fw-bold mb-1" href="#" id="navbarDropdown"
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="#">                        
                                    <form id="logout-form" action="{{ route('logout') }}" method="POST" >
                                        @csrf
                                        <button class="btn"><i class="fas fa-power-off" style="margin-right: 4px "></i>Logout</button>
                                    </form>     
                                </a></li>
                            </ul>
                        </li>
